            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/user_admin')}}" class="sub-active">
                ...
                <li class="sidebar-nav-link">
                    <a href="javascript:;" class="sidebar-nav-sub-title active">
                        <i class="am-icon-table sidebar-nav-link-logo"></i> 类别管理
                        <span class="am-icon-chevron-down am-fr am-margin-right-sm sidebar-nav-sub-ico sidebar-nav-sub-ico-rotate"></span>
                    </a>
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/class')}}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 所有类别
                            </a>
                        </li>

                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/plate')}}" class="sub-active">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 所有板块
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/posts')}}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 帖子操作
                            </a>
                        </li>

                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/reply')}}" class="sub-active">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 回复操作
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-nav-link">
                    <a href="javascript:;" class="sidebar-nav-sub-title active">
                        <i class="am-icon-table sidebar-nav-link-logo"></i> 投诉管理
                        <span class="am-icon-chevron-down am-fr am-margin-right-sm sidebar-nav-sub-ico sidebar-nav-sub-ico-rotate"></span>
                    </a>
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/complain')}}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 投诉详情
                            </a>
                        </li>

                        <li class="sidebar-nav-link">
                            <a href="{{url('admin/problem')}}" class="sub-active">
